    ...
    \begin{columns}
        ...
        \begin{column}{0.4\textwidth}
            \begin{tikzpicture}[scale=0.8]
                ...
                % Cloud box
                \draw[thick, green] (0,3) rectangle (3,4.5);
                \node at (1.5,3.75) {\small Cloud Computing};
                \node[green] at (1.5,3.3) {\tiny Unlimited \& On-demand};
            \end{tikzpicture}
        \end{column}
    \end{columns}
...
% Slide 5: Conclusions and Future Directions
