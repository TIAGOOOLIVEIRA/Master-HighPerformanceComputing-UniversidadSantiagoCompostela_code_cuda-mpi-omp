...
#SBATCH -J warp_shufflefunctions       # Job name
#SBATCH -o warp_shufflefunctions.o%j   # Name of stdout output file(%j expands to jobId)
#SBATCH -e warp_shufflefunctions.o%j   # Name of stderr output file(%j expands to jobId)
...
#OMP_NUM_THREADS=8 ./warp_shufflefunctions
...
for gpu in "${gpu_types[@]}"; do
    ...
    for n in "${n_values[@]}"; do
        ...
        OMP_NUM_THREADS=8 ./warp_shufflefunctions $n
    done
done